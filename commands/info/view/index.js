...
module.exports = {
    infoEmbed : function(){ 
        return new Discord.MessageEmbed()
                ...
                .addFields(
                    {name: 'Description', value:'This bot was created for utility in managing DSC Workspace'},
                    {name: '\u200B', value: '\u200B' },
                    {name: 'Version', value: '0.0.0a',inline: true},
                    {name: 'Status', value:'In-development',inline: true }
                )
                .setFooter('Bot made by baolongv3','https://ca.slack-edge.com/T01SZJQ9K9P-U01U9AQ39QC-06d89ca32aeb-512')
    }
}
